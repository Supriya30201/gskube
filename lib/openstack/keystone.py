...
def unscoped_login(protocol, host, port, username, password):
    try:
        ...
        raise OpenstackException("Exception while performing unscoped login : " + e.message, e)
...
def scoped_login_v3(protocol, host, port, token, project_id):
    try:
        ...
        raise OpenstackException(e.message, e)
...
def list_projects(client):
    try:
        ...
        raise OpenstackException("Exception while getting list of projects : " + e.message, e)
